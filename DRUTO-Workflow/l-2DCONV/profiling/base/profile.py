...
#############################################################################
#############################################################################
makeCommand1 = flagHeader + " 2DConvolution.cu -o 2DConvolution.o" + ktraceFlag 
makeCommand2 = ""
makeCommand3 = ""
makeCommand4 = ""
linkList = " 2DConvolution.o"
outputExeFile = "2dconv.out"
#############################################################################
bmName = "2dconv"
...
def runProfile():
	...
	goldenOutput = subprocess.check_output("./" +outputExeFile, shell=True)
	print goldenOutput
