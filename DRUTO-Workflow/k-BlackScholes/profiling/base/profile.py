...
optFlags = ""
#############################################################################
makeCommand2 = flagHeader + " BlackScholes.cu -o BlackScholes.o" + ktraceFlag 
makeCommand1 = "nvcc -arch=sm_30 BlackScholes_gold.cpp -c -o BlackScholes_gold.o"
makeCommand3 = ""
makeCommand4 = ""
linkList = " BlackScholes.o BlackScholes_gold.o"
outputExeFile = "blackscholes.out"
#############################################################################
bmName = "blackscholes"
